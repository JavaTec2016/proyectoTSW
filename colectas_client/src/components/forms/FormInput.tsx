...
function FormInput({ formId, inputId, type, label, register, errors, validation, onInput }: { formId: string, inputId: string, type: string, label: string, register: UseFormRegister<FieldValues>, errors: FieldErrors<FieldValues>, validation: { [x: string]: RegisterOptions }, onInput: () => any }) {
